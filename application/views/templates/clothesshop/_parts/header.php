                                    ...
                                    <div class="bag-info">
                                        ...
                                        <a class="my-basket dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                            ...
                                            <span class="sum-scope">
                                                (<span class="sumOfItems"><?= $cartItems == 0 ? lang('empty') : $sumOfItems ?></span>)
                                            </span>
                                ...
                                <li<?= uri_string() == '' || uri_string() == MY_LANGUAGE_ABBR ? ' class="active"' : '' ?>><a href="<?= LANG_URL ?>"><?= lang('home') ?></a></li>
                                    <li class="dropdown dropdown-more">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            ?>
                                                    <li<?= uri_string() == $addonPage || uri_string() == MY_LANGUAGE_ABBR . '/' . $addonPage ? ' class="active"' : '' ?>><a href="<?= LANG_URL . '/' . $addonPage ?>"><?= mb_ucfirst(lang($addonPage)) ?></a>
                                    </li>
                                <?php
                                                }
                                            }
